...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('don_hangs', function (Blueprint $table) {
            ...
            $table->foreignId('trang_thai_don_hang_id')->constrained('trang_thai_don_hangs')->onDelete('cascade');
            $table->foreignId('trang_thai_thanh_toan_id')->constrained('trang_thai_thanh_toans')->onDelete('cascade');
            $table->timestamps();
        });
    }
