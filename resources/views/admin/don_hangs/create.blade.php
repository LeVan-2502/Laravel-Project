...
<div class="row mb-3">
                                    ...
                                    <div class="d-flex flex-wrap my-n1">
                                        ...
                                        <div>
                                            <a href="#" class="d-block text-body p-1 px-2">
                                                <i class="ri-star-fill text-muted align-bottom me-1"></i> Add Wishlist
                                            </a>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="col-xl-4">
        <div class="sticky-side-div">
            <form method="POST" action="{{route('admin.don_hangs.store')}}">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body pt-2">
                        <div class="row">
                            ...
                            <div class="mb-3 form-icon col-12">
                                ...
                                <div class="form-icon">
                                    <input value="{{ old('ten_nguoi_nhan') }}" name="ten_nguoi_nhan" type="text" class="form-control form-control-icon" id="iconInput" placeholder="Ex: Nguyen Van A ....">
                            ...
                            <div class="mb-3 form-icon col-12">
                                ...
                                <div class="form-icon">
                                    <input value="{{ old('email_nguoi_nhan') }}" name="email_nguoi_nhan" type="email" class="form-control form-control-icon" id="iconInput" placeholder="example@gmail.com">
                            ...
                            <div class="mb-3 col-12">
                                ...
                                <div class="form-icon">
                                    <input value="{{ old('sdt_nguoi_nhan') }}" name="sdt_nguoi_nhan" type="text" class="form-control form-control-icon" id="iconInput" placeholder="Ex: 0964 032 101">
                            ...
                            <div class="mb-3 col-12">
                                ...
                                <select class="form-select" id="phuong_thuc_id" name="phuong_thuc_id" data-choices="" data-choices-search-false="">
                                    ...
                                    <option value="{{ $id }}" {{ old('phuong_thuc_id') == $id ? 'selected' : '' }}>{{ $ten_phuong_thuc }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3 col-12">
                                ...
                                <div class="form-icon">
                                    <input value="{{ old('dia_chi_nguoi_nhan') }}" name="dia_chi_nguoi_nhan" type="text" class="form-control form-control-icon" id="iconInput" placeholder="Ex: Số 2 Ngách 37 Thổ quan Đống Đa Hà Nội">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-danger">Tạo đơn hàng</button>
                    </div>
                </div>
            </form>
