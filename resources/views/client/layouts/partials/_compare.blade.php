                            ...
                            <tr class="tr-image">
                                ...
                                <td>
                                    <a href="shop-details.html">
                                        <img width="600" height="600" src="{{ asset('theme/ruper/media/product/3.jpg')}}" alt="">
                                    </a>
                                </td>
                                <td>
                                    <a href="shop-details.html">
                                        <img width="600" height="600" src="{{ asset('theme/ruper/media/product/1.jpg')}}" alt="">
                                    </a>
                                </td>
                                <td>
                                    <a href="shop-details.html">
                                        <img width="600" height="600" src="{{ asset('theme/ruper/media/product/2.jpg')}}" alt="">
                                    </a>
                                </td>
                            </tr>
                            <tr class="tr-sku">
