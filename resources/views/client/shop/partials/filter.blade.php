                                ...
                                <div class="block block-product-filter clearfix">
                                    ...
                                    <div class="block-content">
                                        <ul class="filter-items image">
                                            <li><span><img src="{{ asset('theme/ruper/media/brand/1.jpg')}}" alt="Brand"></span></li>
                                            <li><span><img src="{{ asset('theme/ruper/media/brand/2.jpg')}}" alt="Brand"></span></li>
                                            <li><span><img src="{{ asset('theme/ruper/media/brand/3.jpg')}}" alt="Brand"></span></li>
                                            <li><span><img src="{{ asset('theme/ruper/media/brand/4.jpg')}}" alt="Brand"></span></li>
                                            <li><span><img src="{{ asset('theme/ruper/media/brand/5.jpg')}}" alt="Brand"></span></li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <ul class="products-list">
                                            <li class="product-item">
                                                <a href="shop-details.html" class="product-image">
                                                    <img src="{{ asset('theme/ruper/media/product/6.jpg')}}">
                                                </a>
                                            ...
                                            <li class="product-item">
                                                <a href="shop-details.html" class="product-image">
                                                    <img src="{{ asset('theme/ruper/media/product/8.jpg')}}">
                                                </a>
                                                <div class="product-content">
                                                    <h2 class="product-title">
                                                        <a href="shop-details.html">
                                            ...
                                            <li class="product-item">
                                                <a href="shop-details.html" class="product-image">
                                                    <img src="{{ asset('theme/ruper/media/product/9.jpg')}}">
                                                </a>
                                                <div class="product-content">
                                                    <h2 class="product-title">
                                                        <a href="shop-details.html">
